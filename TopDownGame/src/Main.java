...
public class Main {
	...
	public static EZSound backSound = EZ.addSound("resources/background.wav");
	public static EZSound failSound = EZ.addSound("resources/failsound.wav");
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		while(startGame) {
			...
			choose.setFont("resources/8-BIT WONDER.TTF");
			EZText enter = EZ.addText(750, 700, "Press Enter To Start", Color.WHITE, 60); 
			enter.setFont("resources/8-BIT WONDER.TTF");
			EZImage potionSign = EZ.addImage("resources/sign1.png", 1250, 400);
			EZImage controlSign = EZ.addImage("resources/sign2.png", 250, 400);
			...
			EZImage background = EZ.addImage("resources/park.jpg", 750, 400);
			...
			healthBar.setFont("resources/8-BIT WONDER.TTF");
			...
			EZImage background2 = EZ.addImage("resources/trees.png", 750, 400);
			EZText points = EZ.addText(1400, 60, "0", Color.WHITE, 60); 

			//create potions for health
			Potion[] potion = new Potion[5];
			for(int i=0; i<5; i++) {
				potion[i] = new Potion("resources/potion.png", 1500, 800);
			}
			...
			while (run) {
				...
				if (scoreA < scoreB) {//creates new enemies based for score amount
					scoreA = scoreB;
					if (scoreB%2 == 0) {
						villain.add(new Enemy("resources/enemy.png", randomGenerator.nextInt(1500) , randomGenerator.nextInt(800),mainHero, 1500, 800));
					}
